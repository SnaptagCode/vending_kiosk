...
class _PaymentHistoryScreenState extends ConsumerState<PaymentHistoryScreen> {
                    ...
                    rows: response.list.map((order) {
                      return DataRow(
                        ...
                        cells: [
                          ...
                          DataCell(
                            Center(child: Text(_getOrderState(order.orderStatus as OrderStatus))),
                          ),
                          DataCell(
                            Center(child: _getRefundWidget(context, order)),
                          ),
                          DataCell(
                            Center(child: Text(isPrinted(order.printedStatus as PrintedStatus) ? 'O' : 'X')),
                          ),
                          DataCell(
  ...
  TextButton _getRefundWidget(BuildContext context, OrderEntity order) {
    switch (order.orderStatus as OrderStatus) {
      ...
      default:
        switch (order.printedStatus as PrintedStatus) {
          case PrintedStatus.refunded_after_printed:
          case PrintedStatus.refunded_before_printed:
            return TextButton(
              onPressed: null,
